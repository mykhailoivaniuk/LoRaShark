...
// network.
static const PROGMEM u1_t NWKSKEY[16] = { 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC };
...
static const u4_t DEVADDR = 0xAAAAAAAA;
...
// Pin mapping for the ESP32 LoRa 1-CH Gateway
